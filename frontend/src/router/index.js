...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/contests/new', component: () => import('@/views/ContestEditorView.vue'), meta: { requiresManager: true, hideShell: true } },
    { path: '/contests/:id/edit', component: () => import('@/views/ContestEditorView.vue'), meta: { requiresManager: true, hideShell: true } },
